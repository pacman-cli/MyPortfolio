...
export const LightModeBackground = () => {
  ...
  return (
    <div className="fixed inset-0 -z-30 pointer-events-none overflow-hidden dark:hidden bg-slate-50/50">
      {/* Top Left - Soft Mint/Green Abstract Shape (static, no framer-motion) */}
      <div className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] blur-3xl opacity-60 animate-fade-in">
      ...
      {/* Bottom Right - Cyan/Green Blend Abstract Shape (static) */}
      <div className="absolute -bottom-[15%] -right-[5%] w-[60%] h-[60%] blur-3xl opacity-50 animate-fade-in">
      ...
      {/* Static orbs instead of continuously animated ones */}
      <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-green-300/20 rounded-full blur-2xl opacity-50" />
      <div className="absolute bottom-1/3 left-1/4 w-40 h-40 bg-teal-200/20 rounded-full blur-2xl opacity-40" />
    </div>
  )
}

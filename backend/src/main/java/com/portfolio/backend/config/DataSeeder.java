...
public class DataSeeder implements CommandLineRunner {
  ...
  private void seedBlogs() {
    List<Blog> blogs =
        List.of(
            createBlog(
                "LLM Deep Thinking: Reasoning Models, Techniques, Evaluation, "
                    + "and the Landscape",
                "llm-deep-thinking",
                "A comprehensive exploration of how large language models "
                    + "\"think\" — from the internal architecture of reasoning models "
                    + "like o1, R1, and Claude, to practical prompting techniques, "
                    + "rigorous evaluation methods, and a look at where the field is "
                    + "heading.",
                loadContent("llm-deep-thinking"),
                "LLM, Deep Learning, Reasoning, AI Architecture, Prompt " + "Engineering",
                "https://images.unsplash.com/"
                    + "photo-1677442136019-21780ecad995?q=80&w=2070&auto=format&fit=crop",
            ...
            createBlog(
                ...
                "A deep dive into Spring Security's authentication architecture "
                    + "— how filters, providers, and SecurityContextHolder work "
                    + "together to secure your application.",
                loadContent("spring-security"),
                "Spring Security, Java, Authentication, Backend",
                "https://images.unsplash.com/"
                    + "photo-1555066931-4365d14bab8c?q=80&w=2070&auto=format&fit=crop",
                LocalDateTime.of(2026, 5, 10, 10, 0)),
            createBlog(
                "Microservices in Spring Boot: Architecture, Design Patterns, "
                    + "and Production Practices",
                "microservices-spring-boot-architecture",
                "A comprehensive guide to designing, building, and deploying "
                    + "microservices with Spring Boot — covering service discovery, "
                    + "API gateways, resilience patterns, and production deployment "
                    + "strategies.",
                loadContent("microservices-spring-boot"),
                "Microservices, Spring Boot, Java, Architecture, Docker",
                "https://images.unsplash.com/"
                    + "photo-1558494949-ef010cbdcc31?q=80&w=2070&auto=format&fit=crop",
                LocalDateTime.of(2026, 5, 5, 10, 0)),
            createBlog(
                "Data Cleaning and Model Training: A Practical Guide",
                "data-cleaning-model-training",
                "A hands-on guide to data cleaning, preprocessing, and training "
                    + "machine learning models — from handling missing values to "
                    + "feature engineering and model evaluation.",
                loadContent("data-cleaning"),
                "Data Science, Machine Learning, Python, Data Engineering",
                "https://images.unsplash.com/"
                    + "photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop",
    ...
    List<Project> projects =
        List.of(
            createProject(
                "TakaTrack",
                "takatrack",
                "A comprehensive personal finance management platform with "
                    + "real-time visualizations, expense tracking, and savings goal "
                    + "management.",
                "Next.js, Spring Boot, MySQL, Docker",
                "https://github.com/pacman-cli/expense-tracker",
                "https://takatrack.puspo.online",
                "https://images.unsplash.com/"
                    + "photo-1554224155-8d04cb21cd6c?q=80&w=2070&auto=format&fit=crop"),
            createProject(
                "StayMate",
                "staymate",
                "Full-stack rental property marketplace with secure "
                    + "authentication, real-time messaging, and comprehensive listing "
                    + "management.",
                "Next.js, Spring Boot, MySQL, Docker",
                "https://github.com/pacman-cli/staymate",
                "https://staymate-demo.puspo.online",
                "https://images.unsplash.com/"
                    + "photo-1560448204-e02f11c3d0e2?q=80&w=2070&auto=format&fit=crop"),
            createProject(
                "Portfolio",
                "portfolio",
                "Modern developer portfolio built with Next.js 16, featuring "
                    + "scroll-driven animations, dark mode, and responsive design.",
                "Next.js, TypeScript, Tailwind CSS",
                "https://github.com/pacman-cli/MyPortfolio",
                "https://www.puspo.online",
                "https://images.unsplash.com/"
                    + "photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit="
                    + "crop"),
            createProject(
                "E-Commerce",
                "e-commerce",
                "A comprehensive e-commerce platform with product management, "
                    + "shopping cart functionality, and secure checkout processes.",
                "Next.js, Spring Boot, MySQL, Docker",
                "https://github.com/pacman-cli/e-commerce",
                "https://ecommerce.puspo.online/",
                "https://images.unsplash.com/"
                    + "photo-1556742049-0cfed4f6a45d?q=80&w=2070&auto=format&fit=crop"),
            createProject(
                "Java Learning",
                "java-learning",
                "Comprehensive repository of Java learning projects covering "
                    + "core concepts, algorithms, and advanced OOP patterns.",
                "Java, Algorithms, OOP",
                "https://github.com/pacman-cli/Java-Learning",
                null,
                "https://images.unsplash.com/"
                    + "photo-1517694712202-14dd9538aa97?q=80&w=2070&auto=format&fit="
                    + "crop"),
            createProject(
                "Business Analytics Dashboard",
                "business-analytics",
                "Data-driven analytics dashboard for business insights with "
                    + "interactive visualizations and reporting capabilities.",
                "Java, Spring Boot, Analytics",
                "https://github.com/pacman-cli/Java-Learning/tree/main/server/"
                    + "businessAnalytics",
                null,
                "https://images.unsplash.com/"
                    + "photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop"));
